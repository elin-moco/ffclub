...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('person_person', 'nickname',
                      self.gf('django.db.models.fields.EmailField')(default='', blank=True),
                      keep_default=False)
        db.add_column('person_person', 'email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Person.nickname'
        db.delete_column('person_person', 'nickname')
