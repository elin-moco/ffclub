...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('event', ['Video'])

        # Adding unique constraint on 'Activity', fields ['slug']
        db.create_unique('event_activity', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Activity', fields ['slug']
        db.delete_unique('event_activity', ['slug'])

        # Deleting model 'Video'
        db.delete_table('event_video')
