...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DemoApp'
        db.create_table('event_demoapp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('en_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('ch_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('marketplace_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ...
        db.send_create_signal('event', ['DemoApp'])


    def backwards(self, orm):
        # Deleting model 'DemoApp'
        db.delete_table('event_demoapp')
    ...
    models = {
        ...
        'event.award': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"})
        },
        'event.campaign': {
