...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('product_product', 'type',
                      self.gf('django.db.models.fields.CharField')(default='souvenir', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.type'
        db.delete_column('product_product', 'type')
    ...
    models = {
        ...
        'product.product': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'souvenir'", 'max_length': '20'}),
        ...
        'upload.imageupload': {
            ...
            'link2': ('django.db.models.fields.URLField', [], {'max_length': '255'}),
            'link2_text': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
